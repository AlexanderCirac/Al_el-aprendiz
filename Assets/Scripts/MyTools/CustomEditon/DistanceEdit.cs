...
namespace Al.Tools.Edits
{
    ...
    [CustomEditor(typeof(DistanceController))]
    [CanEditMultipleObjects]
    public class DistanceEdit : Editor
    {
        #region Attributes
        Texture2D _image;
        bool _isFlipFlop;
