...
namespace Al.Tools.Edits
{
    ...
    [CustomEditor(typeof(EnemyImputs))]
    [CanEditMultipleObjects]
    public class EnemyInputsEditor : Editor
    {
        #region Attributes
        Texture2D _image;
        bool _isFlipFlop;
