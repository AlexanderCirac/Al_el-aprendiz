...
namespace AlexanderCA.ProMenu
{
    public class PrM_MouseIcon : PrM_Behaviour
    {
        ...
        void LecturaFuncion()
        {
          ...
          {
          if (_uIManager._contenido.m_Opcion7._content._defoultImage != null /*&& SC_MPPU.contenido.m_Opcion7.m_contenido.m_animacionClicar == null*/)
          {
            if (m_imagClic != null)
            {
          ...
          if (/*SC_MPPU.contenido.m_Opcion7.m_contenido.m_iconoClick == null &&*/ _uIManager._contenido.m_Opcion7._content._onClickAnim != null)
          {
        ...
        {
          if (_uIManager._contenido.m_Opcion7._content._onClickImage != null/* && SC_MPPU.contenido.m_Opcion7.m_contenido.m_animacionClicar == null*/)
          {
            if (m_imagIdle != null)
            {
              this.gameObject.GetComponent<Image>().sprite = m_imagIdle;
